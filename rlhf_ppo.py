...
class ScriptArguments:
    ...
    # training parameters
    default_model = "RaushanTurganbay/GPT2_instruct_tuned" # "agi-css/hh-rlhf-sft"
...
if __name__ == "__main__":
    ...
    # LM fine tuned on the dataset ready for dpo
    model = AutoModelForCausalLM.from_pretrained(script_args.model_name_or_path)
    # reference model we have for comparison
